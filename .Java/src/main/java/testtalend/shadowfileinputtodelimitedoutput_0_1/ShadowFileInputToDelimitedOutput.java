...
package testtalend.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public void tFileInputJSON_error(Exception exception, String errorComponent,
	...
	public void tFileInputJSON_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_TESTTALEND_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_TESTTALEND_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TESTTALEND_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_TESTTALEND_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_TESTTALEND_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_TESTTALEND_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TESTTALEND_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_TESTTALEND_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TESTTALEND_ShadowFileInputToDelimitedOutput) {
	...
	public void tFileInputJSONProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/Admin/Desktop/TOS_DI-Win32-20200219_1130-V7.3.1/workspace/TESTTALEND/temp/preview/products.csv"))
				...
				String loopPath_tFileInputJSON = "$.data[*]";
				...
				try {
					filenameOrStream_tFileInputJSON = "C:/Users/Admin/Desktop/TOS_DI-Win32-20200219_1130-V7.3.1/workspace/products.json";
				} catch (java.lang.Exception e_tFileInputJSON) {

					System.err.println(e_tFileInputJSON.getMessage());
				}

				com.jayway.jsonpath.ReadContext document_tFileInputJSON = null;
				try {
					if (filenameOrStream_tFileInputJSON instanceof java.io.InputStream) {
						...
						is_tFileInputJSON = new java.io.FileInputStream((String) filenameOrStream_tFileInputJSON);

					}

					document_tFileInputJSON = parseContext_tFileInputJSON.parse(is_tFileInputJSON, "UTF-8");
					...
					Object result_tFileInputJSON = document_tFileInputJSON.read(compiledLoopPath_tFileInputJSON,
				...
				Object root_tFileInputJSON = null;
				for (Object row_tFileInputJSON : resultset_tFileInputJSON) {
					...
					try {
						jsonPath_tFileInputJSON = "price";
						compiledJsonPath_tFileInputJSON = jsonPathCache_tFileInputJSON
								.getCompiledJsonPath(jsonPath_tFileInputJSON);

						try {

							if (jsonPath_tFileInputJSON.startsWith("$")) {
								if (root_tFileInputJSON == null) {
									root_tFileInputJSON = document_tFileInputJSON
											.read(jsonPathCache_tFileInputJSON.getCompiledJsonPath("$"));
								}
								value_tFileInputJSON = compiledJsonPath_tFileInputJSON.read(root_tFileInputJSON);
							} else {
								value_tFileInputJSON = compiledJsonPath_tFileInputJSON.read(row_tFileInputJSON);
							}
						...
						jsonPath_tFileInputJSON = "imageUrl";
						compiledJsonPath_tFileInputJSON = jsonPathCache_tFileInputJSON
								.getCompiledJsonPath(jsonPath_tFileInputJSON);
						...
						jsonPath_tFileInputJSON = "description";
						compiledJsonPath_tFileInputJSON = jsonPathCache_tFileInputJSON
								.getCompiledJsonPath(jsonPath_tFileInputJSON);
						...
						jsonPath_tFileInputJSON = "category";
						compiledJsonPath_tFileInputJSON = jsonPathCache_tFileInputJSON
								.getCompiledJsonPath(jsonPath_tFileInputJSON);
						...
						jsonPath_tFileInputJSON = "productName";
						compiledJsonPath_tFileInputJSON = jsonPathCache_tFileInputJSON
								.getCompiledJsonPath(jsonPath_tFileInputJSON);
						...
						jsonPath_tFileInputJSON = "content";
						compiledJsonPath_tFileInputJSON = jsonPathCache_tFileInputJSON
								.getCompiledJsonPath(jsonPath_tFileInputJSON);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"testtalend/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 50053 characters generated by Talend Open Studio for Data Integration on the
 * 4 février 2022 14:31:10 CET
 ************************************************************************************************/