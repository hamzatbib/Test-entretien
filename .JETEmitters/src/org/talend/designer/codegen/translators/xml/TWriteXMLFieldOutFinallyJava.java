...
public class TWriteXMLFieldOutFinallyJava
{
  ...
  protected final String TEXT_10 = NL + "\tif (listGroupby_";
  protected final String TEXT_11 = " != null) {" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_12 = "_FINISH\" + (listGroupby_";
  protected final String TEXT_13 = ".hashCode()), \"true\");" + NL + "\t}";
